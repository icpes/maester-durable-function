...
FunctionsToExport = 'Add-MtTestResultDetail', 'Clear-MtDnsCache', 'Clear-MtExoCache', 
               'Clear-MtGraphCache', 'Compare-MtTestResult', 'Connect-Maester', 
               ...
               'ConvertFrom-MailAuthenticationRecordSpf', 'Disconnect-Maester', 
               'Get-MailAuthenticationRecord', 'Get-MtAdminPortalUrl', 
               'Get-MtAuthenticationMethodPolicyConfig', 
               'Get-MtConditionalAccessPolicy', 'Get-MtExo', 'Get-MtGraphScope', 
               'Get-MtGroupMember', 'Get-MtHtmlReport', 'Get-MtLicenseInformation', 
               'Get-MtRole', 'Get-MtRoleMember', 'Get-MtSession', 'Get-MtUser', 
               'Get-MtUserAuthenticationMethod', 
               'Get-MtUserAuthenticationMethodInfoByType', 'Install-MaesterTests', 
               ...
               'Test-MtAppRegistrationsWithSecrets', 'Test-MtCaAllAppsExists', 
               ...
               'Test-MtCaDeviceCodeFlow', 'Test-MtCaDeviceComplianceAdminsExists', 
               ...
               'Test-MtCaExclusionForDirectorySyncAccount', 'Test-MtCaGap', 
               'Test-MtCaGroupsRestricted', 'Test-MtCaLicenseUtilization', 
               'Test-MtCaMfaForAdmin', 'Test-MtCaMfaForAdminManagement', 
               'Test-MtCaMfaForAllUsers', 'Test-MtCaMfaForGuest', 
               'Test-MtCaMfaForRiskySignIn', 'Test-MtCaMisconfiguredIDProtection', 
               ...
               'Test-MtCisaDiagnosticSettings', 'Test-MtCisaDkim', 'Test-MtCisaDlp', 
               'Test-MtCisaDlpAlternate', 'Test-MtCisaDlpBaselineRule', 
               'Test-MtCisaDlpPii', 'Test-MtCisaDmarcAggregateCisa', 
               ...
               'Test-MtCisaMethodsMigration', 'Test-MtCisaMfa', 
               'Test-MtCisaNotifyHighRisk', 'Test-MtCisaPasswordExpiration', 
               'Test-MtCisaPermanentRoleAssignment', 'Test-MtCisaPhishResistant', 
               'Test-MtCisaPrivilegedPhishResistant', 
               'Test-MtCisaRequireActivationApproval', 'Test-MtCisaSafeLink', 
               'Test-MtCisaSafeLinkClickTracking', 
               'Test-MtCisaSafeLinkDownloadScan', 'Test-MtCisaSmtpAuthentication', 
               'Test-MtCisaSpamAction', 'Test-MtCisaSpamAlternative', 
               'Test-MtCisaSpamBypass', 'Test-MtCisaSpamFilter', 
               'Test-MtCisaSpfDirective', 'Test-MtCisaSpfRestriction', 
               'Test-MtCisaSpoSharing', 'Test-MtCisaSpoSharingAllowedDomain', 
               'Test-MtCisAttachmentFilter', 
               'Test-MtCisAttachmentFilterComprehensive', 
               'Test-MtCisAuditLogSearch', 'Test-MtCisaUnmanagedRoleAssignment', 
               'Test-MtCisaWeakFactor', 'Test-MtCisCalendarSharing', 
               ...
               'Test-MtConditionalAccessWhatIf', 'Test-MtConnection', 
               ...
               'Test-MtUserAccessAdmin', 'Test-ORCA100', 'Test-ORCA101', 
               'Test-ORCA102', 'Test-ORCA103', 'Test-ORCA104', 'Test-ORCA105', 
               'Test-ORCA106', 'Test-ORCA107', 'Test-ORCA108', 'Test-ORCA108_1', 
               'Test-ORCA109', 'Test-ORCA110', 'Test-ORCA111', 'Test-ORCA112', 
               'Test-ORCA113', 'Test-ORCA114', 'Test-ORCA115', 'Test-ORCA116', 
               'Test-ORCA118_1', 'Test-ORCA118_2', 'Test-ORCA118_3', 'Test-ORCA118_4', 
               'Test-ORCA119', 'Test-ORCA120_malware', 'Test-ORCA120_phish', 
               'Test-ORCA120_spam', 'Test-ORCA121', 'Test-ORCA123', 'Test-ORCA124', 
               'Test-ORCA139', 'Test-ORCA140', 'Test-ORCA141', 'Test-ORCA142', 
               'Test-ORCA143', 'Test-ORCA156', 'Test-ORCA158', 'Test-ORCA179', 
               'Test-ORCA180', 'Test-ORCA189', 'Test-ORCA189_2', 'Test-ORCA205', 
               'Test-ORCA220', 'Test-ORCA221', 'Test-ORCA222', 'Test-ORCA223', 
               'Test-ORCA224', 'Test-ORCA225', 'Test-ORCA226', 'Test-ORCA227', 
               'Test-ORCA228', 'Test-ORCA229', 'Test-ORCA230', 'Test-ORCA231', 
               'Test-ORCA232', 'Test-ORCA233', 'Test-ORCA233_1', 'Test-ORCA234', 
               'Test-ORCA235', 'Test-ORCA236', 'Test-ORCA237', 'Test-ORCA238', 
               'Test-ORCA239', 'Test-ORCA240', 'Test-ORCA241', 'Test-ORCA242', 
               'Test-ORCA243', 'Test-ORCA244', 'Update-MaesterTests'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCCVsXPRgSyTQ4/
# MNkIauny9SOwGQcfSGDqsJAfIOgZB6CCE5EwggWQMIIDeKADAgECAhAFmxtXno4h
...
# SIb3DQEJBDEiBCBfMkTQjoHn1X5OjeoLU5HVWLmcqJwAxnYV1F8JSaAFQjANBgkq
# hkiG9w0BAQEFAASCAgATocTugUtdD9tRpx3ZHF8ZjVRCR47khDzc/5+Fz214XbKX
# JAgaOpeOiYRWj376zm4etrpo8TPS83cK1JlSKF1csgaNRMiDmxcGd5gzVwDk1ehW
# ya71/hKRhNsIhU1q9kjJTF2TuJiz774KaoHUDFvVuNvyrOZ2DnBm8wXb4RHY7kWu
# IKdZb/buIcymw+11MyTDluxmrkV+MKnl7w+r21mhvgEAL2bz7kQ7CSYLP6j9kdgb
# Ng0Rn+lRQ16oXx5U+BtOmwlekNxFYSYoqgcBENLPdJNLvyWyIC2O7rKmcyCrm9O1
