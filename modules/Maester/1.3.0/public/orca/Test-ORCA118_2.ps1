...
.LINK
    https://maester.dev/docs/commands/Test-ORCA118_2
#>
function Test-ORCA118_2{
    [CmdletBinding()]
    [OutputType([bool])]
    param()

    Write-Verbose "Test-ORCA118_2"
    ...
    $obj = New-Object -TypeName ORCA118_2
    try { # Handle "SkipInReport" which has a continue statement that makes this function exit unexpectedly
        $obj.Run($Collection)
    } catch {
        Write-Error "An error occurred during ORCA118_2: $($_.Exception.Message)"
        throw
    } finally {
        if($obj.SkipInReport) {
    ...
    if($testResult){
        $resultMarkdown += "Well done! Domains are not being allow listed in an unsafe manner in Transport Rules.`n`n%ResultDetail%"
    }else{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAtuHv7fr9oh+Sq
# f9bBFGCoBLXX5l4f8dG6Qimlbps4SqCCE5EwggWQMIIDeKADAgECAhAFmxtXno4h
...
# SIb3DQEJBDEiBCDZC3NcwR1ct8GfBhAlWkOLUgOgBE7zxjVp6x3E3Qj7gDANBgkq
# hkiG9w0BAQEFAASCAgBYC8aHKouPyp1GVZKHGvYR1HWYlvWmkMF2k0jochE8Jvp0
# 4jMQCxfVWNzzO1DZ6RQqIEEx/HmoIppFMJnte6wp2NtiY1TpdE0qo8MWY2FZCeNH
# gQp/AZ38Ep9LL5NcKPhGZ6QnC9+rjqwhFHNa0Y3fkHlxVBk8H9DwRmO1yNWqwepH
# zsKrHJjCXCTo4CImdvYHtWQQ7rc+q8FXhjvO3N/T0EzOEj6lwihryPorODX61YYs
# yZIdXu6Zxkvt54ZTUa8htmP2QmznUvJw146zGEOY0eqbwryRMPW/l+0dhlcLd/fA
# QW3Ew7ZYuQhAjhdFFk+kCpQLQZnqJBQ/CgNyjBEwsW2oI+XHOfKymBxqygPC2XP7
# 9AWadXcwyrs+odXu35IKH8wx52je098IGHzBs3ebhFZI2wIYq0vCDAuRgxESKepm
# qO/FO4xYbzRZAeQobGmQH8iMKRclw2r6BD5FQLU7XNzfZodrhdyZTtpi9qpFmVpF
# JdK133NmQLJ31bHcsU+FsQp0BvqyzIPdUgC3URvZpoVFewnLyDOgzq3yvMbtL/5K
# +PdG+K0DYgZk+7N41bKMgdop3qwLP/xjJb2NbMXq6X/s9tRnw7XyBpAfxcvVGpwS
# +WOeP1jTiLiOGbYdTY6GfUxRCnWD+ZlKJv24T4cYg3tA3QCi/ZLV0cUZdShuOqGC
...
# /WwHATAxMA0GCWCGSAFlAwQCAQUABCDFw4Dok9bCnSD8eZmr2qPOn8ux8j7nPqve
# BUOZiqkbXQIRAK/wxyHsWpyKzGHBwYkf744YDzIwMjUwNjIzMjM0NDM2WqCCEwMw
...
# CRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwNjIzMjM0NDM2WjArBgsqhkiG9w0BCRAC
# DDEcMBowGDAWBBTb04XuYtvSPnvk9nFIUIck1YZbRTAvBgkqhkiG9w0BCQQxIgQg
# M+YCz0ys828+L6eXGjZziLVHHMzd3gXLRUxwlDRp55UwNwYLKoZIhvcNAQkQAi8x
# KDAmMCQwIgQgdnafqPJjLx9DCzojMK7WVnX+13PbBdZluQWTmEOPmtswDQYJKoZI
# hvcNAQEBBQAEggIAjMF+DKxzR5rib7/hnrbCaVrDI7mERwsS/IYvr7ZETkLrgVgb
# Kq6jhoOSbQiu+RTQp6FGjz0rqMN2u1UqJ6znsplkoSMOVpedVH9SVMlSOERx/VIb
# qhdmLfyU2gijTqJULuy0M3Nmu0hqlItaYGm3RQqXUWeaiAHvSKx7z6pwC9G3euT5
# X9BgKs/V/aQvkthJkhCNG21+z9LtrH4+L/x/p9X0ZFD9MKnxMRbUUg6Nhdg25jc1
# Zu6k2Q0TExZ1IXOIueA4ovk0VIitsWsDDsbiWTomd7HMz2XbUOEgfn/ziFg9lrFp
# IBqjB2coH3vMRvE121kJvaDkXZKCACHy28+Xdjv+sbxW5mFmf+cvig6ZUYjHz8y4
# UxKuqyNJtc+sRQyOqBogf+KOZQe83hty8Tpe/jECD+kEJSehfBqNwLROxMhqkAVH
# znKJ64NWSVAttrcA8bAEZeeX8P7zNxU+olzHnw1IYSGsEgZqTbWnLvDelFVrPlm0
# Dp3eFZZnCKRGMCdB6hbJOETblOWR6sUuqbNA9V5yhmB7cd2VLYFXtAA2ARi7zh74
# 4F5j3mfsaqC4FPqdUVJc03+qvA0cjIuopZYLgMNy5cw2cjfgfOUvZkMcIdKxjGuL
# OlvNkHXZjgkytVb3IoyUnnZKLm8z66dteu1PKQ0LkfzEngjZlU0JsWH+wr4=
